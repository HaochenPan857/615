...
## Discussion 
For this part of the whole project, we are able to find some conclusions but there are still some problems.  
...
This part is for residual plots. The first 4 are the empathy ~ stress + self_care_variables + Current Student Year + Age + Marrage situation formula and the rest are for the stress ~ empathy + self_care_variables + Current Student Year + Age + Marrage situation. We can also analyze these residual plots. 
